...
const QuoteContainer = ({ quote }: QuoteContainerProps): React.ReactElement => {
  ...
  return (
    <div className="p-5 w-5/6 xl:w-4/6 2xl:w-1/2 h-auto place-self-center flex flex-col flex-wrap gap-1 justify-center items-center rounded-xl bg-transparent transition delay-400 duration-200 ease-in-out group hover:backdrop-blur hover:border">
